  ...
  return (
    <div>
      <h2 id="ferme-heading" data-cy="FermeHeading">
        <Translate contentKey="gestionDesFermesApp.ferme.home.title">Fermes</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="gestionDesFermesApp.ferme.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/ferme/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="gestionDesFermesApp.ferme.home.createLabel">Create new Ferme</Translate>
          </Link>
        </div>
      </h2>
        ...
        {fermeList && fermeList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="gestionDesFermesApp.ferme.id">ID</Translate>{' '}
                ...
                <th className="hand" onClick={sort('photo')}>
                  <Translate contentKey="gestionDesFermesApp.ferme.photo">Photo</Translate>{' '}
                  ...
                  <td>
                    {ferme.photo ? (
                      <div>
                        ...
                        <span>
                          {ferme.photoContentType}, {byteSize(ferme.photo)}
                        </span>
                      </div>
                    ) : null}
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="gestionDesFermesApp.ferme.home.notFound">No Fermes found</Translate>
            </div>
          )
        )}
      </div>
